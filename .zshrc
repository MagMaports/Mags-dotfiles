...
alias cat='bat'
alias ytmusic='yt-dlp -x --audio-format mp3 --embed-metadata --add-metadata -o "~/Music/%(title)s.%(ext)s"'
...
export PATH=$PATH:/home/painter/.spicetify

# Created by `pipx` on 2026-06-01 07:50:49
# export PATH="$PATH:/home/painter/.local/bin"
